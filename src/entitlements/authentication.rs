...
pub struct Authentication {
    ...
    /// passwords for AutoFill in Safari and other apps.
    ///
    /// To add this entitlement to a target, enable the AutoFill Credential Provider capability in Xcode.
    /// Do this for both your Password AutoFill extension and its host app.
    ///
    /// ## Availability
    /// * iOS 12.0+
    /// * macOS 11.0+
    ...
    ///
    /// To add this entitlement to your app with the correct associated value, enable the Sign in with
    /// Apple capability in Xcode.
    ///
    /// ## Availability
    /// * iOS 13.0+
    /// * macOS 10.15+
