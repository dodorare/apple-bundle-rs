...
pub struct Wallet {
    ...
    /// If your provisioning profile is associated with multiple pass type identifiers, specify which of the identifiers your app can interact with.
    ...
    /// For information on functionality that’s available to app clips, see Choosing the Right Functionality for Your App Clip.
    ///
    /// ## Availability
    /// * iOS 6.0+
    /// * watchOS 2.0+
    ...
    #[serde(
        rename(serialize = "com.apple.developer.pass-type-identifiers"),
    ...
    ///
    /// To add this entitlement, enable the Apple Pay capability in Xcode and select the merchant IDs you want to use in your app.
    /// Alternatively, see Setting Up Apple Pay Requirements for how to create merchant IDs in your developer account.
    ///
    /// ## Availability
    /// * iOS 6.0+
    /// * watchOS 2.0+
    ...
    /// * PassKit (Apple Pay and Wallet)
    #[serde(
        rename(serialize = "com.apple.developer.in-app-payments"),
        skip_serializing_if = "Option::is_none"
    )]
