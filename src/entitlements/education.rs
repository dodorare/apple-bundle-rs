...
pub struct Education {
    ...
    ///
    /// To add the entitlement to your app, set the entitlement’s type to Boolean in the Xcode property list editor,
    /// and the corresponding value to YES.
    ///
    ...
    ///
    /// ## Important
    /// If your app has a deployment target earlier than macOS 11, to use the com.apple.developer.automatic-assessment-configuration
    /// entitlement, your app also needs the com.apple.security.temporary-exception.mach-lookup.global-name entitlement.
    /// Add this to your app’s entitlements file with a corresponding value that’s an array of strings containing the
    /// string com.apple.assessmentagent.
    ///
    /// ## Availability
    /// * iOS 13.4+
    /// * macOS 10.15.4+
